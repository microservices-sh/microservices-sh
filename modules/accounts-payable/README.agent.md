...
Use `voidBill` only for unpaid bills. Posted bills require an accounting poster that reverses the bill journal before AP status is voided. Bills with payment applications must wait for payment void first.
