...
const INTERNAL_CATALOG_MODULES = Object.freeze([
  ...
  catalogModule({
    ...
    status: "draft",
    summary: "Tenant-scoped bank accounts, statement import mapping detection/presets, matching corrections, exclusions, and reconciliation completion with integer-cent balances.",
