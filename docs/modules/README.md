...
| [`sales-order`](./sales-order.md) | Draft | Sales orders, line items, status transitions, bulk confirm/cancel, send attempts, reservation handoff, and invoice draft handoff. |
...
| [`bank-reconciliation`](./bank-reconciliation.md) | Draft | Bank accounts, imported transactions, statement lines, matching corrections, exclusions, and reconciliation state. |
