...
<main class="section">
  <div class="content-grid">
    <section>
      ...
      <h1>Log in to your operator workspace.</h1>
      <p>
    ...
    <Card>
      ...
      <p class="mt-4 text-[0.9rem]">Workspace not set up yet? <a href="/signup">Set up your workspace</a>.</p>
    </Card>
  </div>
</main>
