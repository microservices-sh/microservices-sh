...
// in the gateway; this file is only the MCP transport. The tool manifest is
// generated (${manifestModule}); the handler/dep binding + actor context are the
// app's edit seam — edit ${wiringModule}, not this file.
...
import { toolManifest as manifest } from "${manifestModule}";
import { handlers, schemas, authorize, audit, actorContext } from "${wiringModule}";
