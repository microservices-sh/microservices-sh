...
export const REPO_TEMPLATE_MODULES = {
  ...
  "client-portal-sveltekit": ["auth", "identity", "email", "gateway", "customer", "invoice", "file-media", "storage-entitlements", "audit-log"],
