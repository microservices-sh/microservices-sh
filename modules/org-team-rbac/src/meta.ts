...
// Build a Result envelope Meta for an org-team-rbac use-case. correlationId is
// threaded from the caller (edge/dispatcher) when present, otherwise minted.
// See Plan 25 §4.
export function orgTeamRbacMeta(deps?: { correlationId?: string; now?: () => number }): Meta {
  return withMeta({
    source: "org-team-rbac",
