---
name: commerce-sync-operator
description: Use when operating the Commerce Sync module through agentic tools, admin workflows, or support triage.
---

# Commerce Sync Operator
