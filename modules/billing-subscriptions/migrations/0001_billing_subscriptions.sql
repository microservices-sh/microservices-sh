-- Billing & Subscriptions owns plans, subscriptions, a webhook/usage idempotency
-- ledger, and usage records. Money is integer cents.
...
-- Idempotency ledger for Stripe webhook ids (and namespaced usage keys). A
-- redelivered event id cannot be applied twice.
