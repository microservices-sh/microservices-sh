...
- Donor-backed next AP priorities from subagent scan: bill detail plus approval/post split, AP payment workbench with multi-bill/partial applications, void/reversal lifecycle, and vendor master lifecycle/1099 summary. Bill detail and payment workbench are the strongest next low-to-medium risk template/module slices; void/reversal has higher accounting risk and should follow a tighter design pass.
