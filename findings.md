...
- Donor-backed next AP priority from subagent scan: unpaid bill void as a domain-level module/template slice. Payment void/reversal remains higher risk because it mutates multiple bill balances and needs accounting-core-safe journal reversal design.
