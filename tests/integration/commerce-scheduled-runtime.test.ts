...
import { runCommerceScheduled } from "../../templates/commerce-ops-sveltekit/src/lib/server/scheduled.ts";

describe("commerce scheduled runtime", () => {
  it("runs schedule catch-up and due job execution through shared module handlers", async () => {
    const result = await runCommerceScheduled(
