...
const INTERNAL_CATALOG_MODULES = Object.freeze([
  ...
  catalogModule({
    ...
    status: "draft",
    summary: "Tenant-scoped bank accounts, statement import mapping detection/presets, CSV preview/dedup review, matching corrections, exclusions, provisional clear/unclear state, and reconciliation completion with integer-cent balances.",
    ...
    surfaces: {
      ...
      agentic: {
        ...
        tools: [
          ...
          "bank-reconciliation.detectStatementImportFieldMapping",
          "bank-reconciliation.previewStatementImportCsv",
          ...
          "bank-reconciliation.clearReconciliationTransaction",
          "bank-reconciliation.unclearReconciliationTransaction",
