...
- `bulkTransitionOrders` is limited to confirm/cancel batch operations and delegates to the single-order transition APIs. Do not use it for invoice handoff until invoice creation has end-to-end idempotency.
