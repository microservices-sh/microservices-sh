// Email provider/repository selection (revamp P3a). Console provider by default
// so dev works with no keys; Resend when RESEND_API_KEY is set. Repository is
// D1-backed in production, in-memory locally.
