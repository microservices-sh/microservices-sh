...
- Banking now exposes imports, auto-detected mapping, mapping presets, CSV preview/dedup review, import detail review, match suggestions, match creation, unmatch/exclude/restore correction actions, reconciliation start, reconciliation completion, and reconciliation detail review in the accounting template workflow. Remaining backlog is clear/unclear operations, richer summaries/history, and provider/OCR hooks.
