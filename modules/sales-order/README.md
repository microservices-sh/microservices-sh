...
The module owns tenant-scoped sales order identity, line items, customer references/snapshots, external source references, integer-cent totals, status transitions, schemas, hooks, events, permissions, resources, D1/memory stores, and migrations for `sales-order`.
