<script lang="ts">
	...
	const ICONS: Record<string, string> = {
		...
		'book-open':
			'<path d="M12 7v14"/><path d="M3 18a1 1 0 0 0 1 1h5a3 3 0 0 1 3 2V7a3 3 0 0 0-3-3H4a1 1 0 0 0-1 1z"/><path d="M21 18a1 1 0 0 1-1 1h-5a3 3 0 0 0-3 2V7a3 3 0 0 1 3-3h5a1 1 0 0 1 1 1z"/>',
		landmark:
