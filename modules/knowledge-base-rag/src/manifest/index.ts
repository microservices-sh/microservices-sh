export const manifest = {
  ...
  runtime: {
    ...
    routeAdapters: ["sveltekit-later", "hono-later"]
  },
  ...
  resources: [
    {
      type: "d1",
      binding: "DB",
      tables: ["knowledge_articles", "knowledge_sources", "knowledge_attachments", "knowledge_web_scan_jobs", "knowledge_feeds", "domain_events"]
    }
  ],
  permissions: [
  ...
  connections: {
    requires: [],
    optional: ["auth", "org-team-rbac", "audit-log", "file-media", "support-ticket", "ai-gateway", "jobs-workflows"],
    rpc: {
      exposes: [
      ...
      calls: [
        { module: "ai-gateway", method: "complete", scope: "ai.invoke", optional: true },
        { module: "file-media", method: "getFile", scope: "file-media.read", optional: true },
        { module: "support-ticket", method: "saveDraftReply", scope: "support-ticket.write", optional: true }
      ]
    },
    events: {
      emits: [
    ...
    hookPoints: {
      beforeArticleCreate: { kind: "filter", scope: "knowledge-base-rag.extend" },
      beforeArticleUpdate: { kind: "filter", scope: "knowledge-base-rag.extend" },
      afterAttachmentAdded: { kind: "observer", scope: "knowledge-base-rag.observe" },
      afterGroundedAnswerDrafted: { kind: "observer", scope: "knowledge-base-rag.observe" }
    },
    provides: { hooks: [] }
  },
  customization: {
  ...
  surfaces: {
    ...
    visitor: { applicable: false },
    agentic: {
      applicable: true,
      tools: [
        "knowledge-base-rag.createArticle",
        "knowledge-base-rag.getArticle",
        "knowledge-base-rag.listArticles",
        "knowledge-base-rag.updateArticle",
        "knowledge-base-rag.recordSource",
        "knowledge-base-rag.listSources",
        "knowledge-base-rag.attachArticleFile",
        "knowledge-base-rag.listAttachments",
        "knowledge-base-rag.createWebScanJob",
        "knowledge-base-rag.listWebScanJobs",
        "knowledge-base-rag.updateWebScanJob",
        "knowledge-base-rag.createKnowledgeFeed",
        "knowledge-base-rag.listKnowledgeFeeds",
        "knowledge-base-rag.updateKnowledgeFeed",
        "knowledge-base-rag.searchKnowledge",
        "knowledge-base-rag.answerQuestion",
        "knowledge-base-rag.draftSupportReply"
      ],
      skillPaths: ["skills/knowledge-base-rag-operator/SKILL.md"],
      approvalRequiredFor: [
        "knowledge-base-rag.createArticle",
        "knowledge-base-rag.updateArticle",
        "knowledge-base-rag.recordSource",
  ...
  skills: [
    {
      id: "knowledge-base-rag-operator",
      path: "skills/knowledge-base-rag-operator/SKILL.md",
      recommendedFor: ["admin-operations", "support-triage", "knowledge-curation", "agentic-tools"]
    }
  ],
  approval: {
    risk: "medium",
    requiresApprovalFor: ["migrations", "pii-fields", "ai-provider-calls", "production-deploy", "external-side-effects"]
  }
} as const;
