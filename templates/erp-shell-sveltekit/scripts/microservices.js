...
const appId = cleanString(manifest.id) ?? cleanString(lock.template) ?? "erp-shell-sveltekit";
const appDisplayName = cleanString(manifest.displayName) ?? "ERP Shell SvelteKit";
